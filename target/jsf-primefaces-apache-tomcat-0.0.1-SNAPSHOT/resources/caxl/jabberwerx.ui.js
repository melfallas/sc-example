    ...
    jabberwerx = jq.extend(jabberwerx, {
        ...
        _getInstallPath: function () {
            ...
            if (!p) {
                ...
                //p = "js/plugins/jabber/jabberwerx.ui.js";
...
(function (jabberwerx) {
    ...
    jabberwerx.ui.TabbedView.Tab = jabberwerx.ui.JWView.extend({
        ...
        createDOM: function (doc) {
            ...
            jabberwerx.$("<img/>").appendTo(builder).attr("src", jabberwerx.ui.getThemeImageURL("icon-close2.gif")).attr("alt", "Cerrar").attr("title", "Cerrar").bind("click", this.invocation("_handleClose")).addClass("closer");
            return builder.get(0);
        },
        restoreDOM: function (doc) {
...
(function (jabberwerx) {
    jabberwerx.ui.AuthenticationView = jabberwerx.ui.JWView.extend({
        ...
        createDOM: function (doc) {
            ...
            var loaderDiv = jabberwerx.$("<div/>").appendTo(data).addClass("chat_loader");
            jabberwerx.$("<img src='images/Spinner-1s-200px.gif' />").appendTo(loaderDiv);
